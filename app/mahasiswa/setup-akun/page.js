    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-3xl shadow-xl border border-white/60 dark:border-slate-700 w-full max-w-lg overflow-hidden">
        ...
        <div className="p-8">
          ...
          {success && (
            <div className="bg-teal-50 dark:bg-teal-900/20 border border-teal-200 dark:border-teal-800 text-teal-600 dark:text-teal-400 p-4 rounded-xl text-sm mb-6 font-medium">
              {success}
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 border border-white/60 dark:border-slate-700 rounded-xl bg-white/20 dark:bg-slate-900/20 focus:ring-2 focus:ring-teal-600 focus:border-teal-600 text-slate-900 dark:text-white pr-12"
