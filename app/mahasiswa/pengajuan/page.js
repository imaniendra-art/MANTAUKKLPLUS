      ...
      <DashboardLayout title="Pusat Dokumen KKL Plus">
        <div className="bg-white/40 dark:bg-slate-800/40 backdrop-blur-xl rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-700">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white/40 dark:bg-slate-900/20 rounded-2xl border border-slate-100 p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              
              {/* Surat Pengantar */}
              <div className="flex flex-col p-5 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Otomatis dari sistem</p>
                  </div>
                </div>
                <div className="mt-auto self-end">
                  <button onClick={() => window.open(`/mahasiswa/surat/pengantar/${pokja._id}`, '_blank')} className="px-4 py-2 bg-teal-50 hover:bg-teal-100 text-teal-600 text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Generate PDF</button>
                </div>
              </div>
              ...
              <div className="flex flex-col p-5 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Bukti diterima oleh Mitra</p>
                  </div>
                </div>
                <div className="mt-auto self-end">
          ...
          <div className="space-y-4 mt-8">
            ...
            <div className="bg-white/40 dark:bg-slate-900/20 rounded-2xl border border-slate-100 p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="flex flex-col p-5 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Kerjasama tingkat universitas</p>
                  </div>
                </div>
                <div className="mt-auto self-end">
                {pokja.mitra_id?.file_mou ? (
                  <div className="flex gap-2">
                    <a href={pokja.mitra_id.file_mou} target="_blank" className="px-4 py-2 bg-teal-50 text-teal-600 text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Lihat MOU</a>
                    {isKetua && (
                      <>
                        <input type="file" id="upload-mou-ulang" className="hidden" accept=".pdf" onChange={(e) => handleFileUpload(e, 'mou')} />
                        <label htmlFor="upload-mou-ulang" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload Ulang</label>
                      </>
                    )}
                  </div>
                ) : (
                  isKetua ? (
                    <>
                      ...
                      <label htmlFor="upload-mou" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload MOU</label>
                    </>
                  ) : (
                    <span className="text-sm font-bold text-slate-400 whitespace-nowrap">Belum Tersedia</span>
                  )
                )}
                </div>
              </div>
              ...
              <div className="flex flex-col p-5 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Kerjasama tingkat fakultas</p>
                  </div>
                </div>
                <div className="mt-auto self-end">
                {pokja.mitra_id?.file_moa ? (
                  <div className="flex gap-2">
                    <a href={pokja.mitra_id.file_moa} target="_blank" className="px-4 py-2 bg-amber-50 text-amber-600 text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Lihat MOA</a>
                    {isKetua && (
                      <>
                        <input type="file" id="upload-moa-ulang" className="hidden" accept=".pdf" onChange={(e) => handleFileUpload(e, 'moa')} />
                        <label htmlFor="upload-moa-ulang" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload Ulang</label>
                      </>
                    )}
                  </div>
                ) : (
                  isKetua ? (
                    <>
                      ...
                      <label htmlFor="upload-moa" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload MOA</label>
                    </>
                  ) : (
                    <span className="text-sm font-bold text-slate-400 whitespace-nowrap">Belum Tersedia</span>
                  )
              ...
              <div className="flex flex-col p-5 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1">Perjanjian teknis pelaksanaan</p>
                  </div>
                </div>
                <div className="mt-auto self-end">
                {pokja.mitra_id?.file_ia ? (
                  <div className="flex gap-2">
                    <a href={pokja.mitra_id.file_ia} target="_blank" className="px-4 py-2 bg-amber-50 text-amber-600 text-sm font-bold rounded-lg transition-colors whitespace-nowrap">Lihat IA</a>
                    {isKetua && (
                      <>
                        <input type="file" id="upload-ia-ulang" className="hidden" accept=".pdf" onChange={(e) => handleFileUpload(e, 'ia')} />
                        <label htmlFor="upload-ia-ulang" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload Ulang</label>
                      </>
                    )}
                  </div>
                ) : (
                  isKetua ? (
                    <>
                      ...
                      <label htmlFor="upload-ia" className="cursor-pointer px-4 py-2 bg-slate-100 text-slate-600 text-sm font-bold rounded-lg whitespace-nowrap hover:bg-slate-200">Upload IA</label>
                    </>
                  ) : (
                    <span className="text-sm font-bold text-slate-400 whitespace-nowrap">Belum Tersedia</span>
                  )
