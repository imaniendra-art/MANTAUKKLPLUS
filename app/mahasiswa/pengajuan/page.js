            ...
            <div className="bg-white/40 dark:bg-slate-900/20 rounded-2xl border border-slate-100 p-2 space-y-2">
                  ...
                  isKetua ? (
                    ['berjalan', 'selesai'].includes(pokja.status_pokja) ? (
                      <>
                        ...
                        <label htmlFor="upload-loa" className="cursor-pointer px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-lg transition-colors whitespace-nowrap">Upload LOA</label>
                      </>
                    ) : (
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm">
                ...
                {pokja.file_surat_tugas ? (
                   <a href={pokja.file_surat_tugas} target="_blank" className="px-3 py-1.5 bg-emerald-50 text-emerald-600 text-xs font-bold rounded-lg transition-colors whitespace-nowrap">Lihat Dokumen</a>
                ) : (
            ...
            <div className="bg-white/40 dark:bg-slate-900/20 rounded-2xl border border-slate-100 p-2 space-y-2">
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm">
                ...
                {pokja.mitra_id?.file_mou ? (
                  <a href={pokja.mitra_id.file_mou} target="_blank" className="px-3 py-1.5 bg-purple-50 text-purple-600 text-xs font-bold rounded-lg transition-colors whitespace-nowrap">Lihat MOU</a>
                ) : (
                  isKetua ? (
                    <>
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm">
                ...
                {pokja.mitra_id?.file_moa ? (
                  <a href={pokja.mitra_id.file_moa} target="_blank" className="px-3 py-1.5 bg-pink-50 text-pink-600 text-xs font-bold rounded-lg transition-colors whitespace-nowrap">Lihat MOA</a>
                ) : (
                  isKetua ? (
                    <>
              ...
              <div className="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 shadow-sm">
                ...
                {pokja.mitra_id?.file_ia ? (
                  <a href={pokja.mitra_id.file_ia} target="_blank" className="px-3 py-1.5 bg-rose-50 text-rose-600 text-xs font-bold rounded-lg transition-colors whitespace-nowrap">Lihat IA</a>
                ) : (
                  isKetua ? (
                    <>
